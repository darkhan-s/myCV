...
\begin{itemize}
    ...
    \item Developed the C# backend of the alerting and the forecasting services for the Energy Management software. Maintained the installation scripts and its technical documentation.
