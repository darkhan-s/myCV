...
\begin{minipage}[t]{0.65\textwidth} % Left side for name and title
    ...
    Self-driven software engineer with 6 years of professional experience developing and delivering software-based solutions. Interested in automation and digitization of day-to-day applications using state-of-the-art machine learning methodologies.
\end{minipage}
\hfill
\begin{minipage}[t]{0.32\textwidth} % Right side for contact information, aligned at the top
    ...
    \raggedleft 
    \footnotesize 
    % temporarily removed phone number as it is turned off
    % \faHome\ \; (+358) 046 550 32 34 \\[0.2cm]  
    \faBriefcase\ \; (+358) 050 3358964 \\[0.2cm]  
...
\begin{itemize}
    ...
    \item Developed the C\# backend of the alerting and the forecasting services for the Energy Management software. Maintained the build pipeline, installation scripts and its technical documentation.
    \item Skills: C\#.NET, RTDB (time-series database), REST API, Azure DevOps, batch scripting, OSS scan
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Languages:} Kazakh (Native), Russian (Native), English (Fluent, IELTS 7.0), Finnish (Intermediate, B1)
